package sg.edu.rp.c346.id22015529.demosimplelistviewexamtips;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        examTips[1] = "Seek help from the lecturer ASAP, don't wait until you're lost in the jungle." ;
        examTips[2] = "Prepare your template source code for each topic." ;
        examTips[3] = "Create a few empty Android projects to speed up coding during the exam." ;
